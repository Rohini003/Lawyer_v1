...
import heroImg01 from "../assets/images/lawyer2.avif";
import heroImg02 from "../assets/images/lawyer1.jpg";
import heroImg03 from "../assets/images/lawyer3.jpg";
          ...
          <div className="conatiner">
            <div className="flex items-center justify-between flex-col lg:flex-row">
              ...
              <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
                <img src={heroImg02} className="w-3/4" alt="" />
